import { combineHashes, int, nat, string } from "./primitives.js";
import { Equality, Hash, mkEquality, mkHash, mkOrder, mkOrderAndHash, Order, Relation, Thing } from "./things.js";
