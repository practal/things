...
export interface PartialOrder<T> extends Equivalence<T> {
     ...
     * * *Compatible with Equality*: compare(x, y) === [[EQUAL]] is true iff equals(x, y) is true
     * * *Antisymmetry*: 
...
export interface Comparable extends Equatable {
     ...
     * 
     * It is possible to represent partial orders, by returning [[UNRELATED]] if this and other are not related.
     * 
